...
class Aplicacao:
    ...
    def quadros_da_tela(self):
        self.frame_1 = Frame(self.raiz, bd=0, bg='#1C1C1C',
                             highlightbackground='#1C1C1C', highlightthickness=3)
        self.frame_1.place(relx=0.02, rely=0.02, relwidth=0.96, relheight=0.15)

        self.frame_2 = Frame(self.raiz, bd=0, bg='#1C1C1C',
                             highlightbackground='#1C1C1C', highlightthickness=3)
    ...
    def componentes(self):
        ...
        self.bt_play = Button(self.frame_1, text='STOP', bd=0, bg='#FF8C00', fg='black', font=('verdana', 10, 'bold'), command=self.funcao_parar)
        self.bt_play.place(relx=0.01, rely=0.1, relheight=0.6, relwidth=0.2)

        self.bt_aleatorio = Button(self.frame_2, text=' reprodução \n aleatoria', bd=0, bg='#FF8C00', fg='black', font=('verdana', 10, 'bold'), command = self.reproducao_aleatoria)
        self.bt_aleatorio.place(relx=0.01, rely=0.1, relheight=0.10, relwidth=0.2)

        self.bt_sequencial = Button(self.frame_2, text='reprodução \n sequencial', bd=0, bg='#FF8C00', fg='black', font=('verdana', 10, 'bold'))
        self.bt_sequencial.place(relx=0.01, rely=0.3, relheight=0.10, relwidth=0.2)

        self.label_mensagem = Label(self.frame_2, text='', font=('verdana', 12, 'bold'), bg='#1C1C1C', fg = '#FF8C00')
        self.label_mensagem.place(relx=0.4, rely=0.3)

        self.label_mensagem_mes = Label(self.frame_2, text='', font = ('verdana', 12, 'bold' ), bg ='#1C1C1C', fg ='#FF8C00')
    ...
    def combobox(self):
        ...
        self.combo_dias = ttk.Combobox(self.frame_1, values=self.valores_dias)
        ...
        self.combo_meses = ttk.Combobox(self.frame_1, values=self.valores_mes)
